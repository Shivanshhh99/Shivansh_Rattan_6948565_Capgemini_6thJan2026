...
namespace ConsecutiveCharacterDeletion
{
    class MaximumConsecutiveDeletion
    {
        static void Main(string[] args)
        {
            //enter that string which contains consective characters
        ...
        // to calculate maximum deletions of consecutive character pairs
